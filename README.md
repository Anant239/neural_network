This repository contains code for simple neural network implementation without using sklearn's Neural Network library. To run the Neural Network code, these are the steps need to be followed -
